<x-guest-layout>
    ...
    <section class="bg-[url(/public/hero/vawe-01.jpg)] bg-no-repeat bg-cover bg-bottom bg-gray-300 bg-blend-multiply">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24">
            ...
            <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
                1250 предложений в Санкт-Петербурге.
            </p>
            <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                ...
                <div
                    ...
                    <x-input id="email" class="block mt-1 w-full" type="number" name="email" :value="old('email')"
    ...
    {{-- <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div class="flex items-center justify-center rounded-sm bg-gray-50 w-64 dark:bg-gray-800">
                <aside id="default-sidebar"
                    class="z-40 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            ...
            <div class="flex items-center justify-center rounded-sm bg-gray-50 dark:bg-gray-800">
                <p class="h-28 text-2xl text-gray-400 dark:text-gray-500">
